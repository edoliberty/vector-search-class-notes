...
* 11/10 - [Class 8 - Quantization for lossy vector compression](class_notes/Class_08_quantization.pdf) [Matthijs] **This class will take place remotely via zoom, see the edstem message to get the link**
